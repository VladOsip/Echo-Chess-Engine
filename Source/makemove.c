...
4. move the currect piece from -> to
5. if a capture was made, remove captured from the piece list
6. update 50 move rule, see if pawn was moved
7. promotions
8.EnPas Captures
9. Set Enpas square if PStart
10. for all pieces added, moved or removed - update all position
Counters and piece lists
11. maintain and update position key
12. Check castle premissions
...
const int CastlePerm[120] = {//used for masking castling permission
...
/*ClearPiece, AddPiece and MovePiece work 
 like they would in a queue data structure */
